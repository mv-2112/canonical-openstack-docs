...
.. terminal::
   ...
   openstack rating hashmap field create $SERVICE_UUID flavor_id
...
.. terminal::
   ...
   openstack rating hashmap mapping create 0.01 --field-id $FIELD_UUID --value $(openstack flavor show m1.tiny -f value  -c id) -g $GROUP_UUID -t flat
